            ...
            <div class="col-md-12 col-lg-12">
                <div class="mb-3 card">
                    ...
                    <div>
                        ...
                        <form action="{{ '/report/pengeluaran-barang/download' }}" class="px-4" id="form" method="POST">
                            <div class="form-group">
                                <label>Filter Berdasarkan</label>
                                <select type="text" name="filterByDate" class="form-control col-sm-3">
                                    <option value="">Pilih Kolom</option>
                                    <option value="created_on">Created On</option>
                                    <option value="updated_on">Updated On On</option>
...
<script type="text/javascript">
    var dataArray1 = @json($pengeluaranBarangColumn);
